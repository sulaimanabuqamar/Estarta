...
class Team(models.Model):
    ...
    team_name = models.CharField(max_length=25, null=False)
    team_logo = models.ImageField(upload_to='team_logos/', null=False)
    manager_fname = models.CharField(max_length=25, null=False)
    manager_lname = models.CharField(max_length=25, null=False)
    manager_number = models.BigIntegerField(null=False)
    manager_email = models.EmailField(max_length=25, null=False)
