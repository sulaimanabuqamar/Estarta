...
class PlayerAdmin(admin.ModelAdmin):
    list_display = ['player_fname', 'player_lname', 'player_age', 'player_number', 'player_email', 'player_image', 'team_id', 'field_goals', 'field_goals_percentage', 'three_pointers', 'three_pointers_percentage', 'free_throws', 'free_throws_percentage', 'rebounds', 'assists', 'steals', 'blocks', 'turnovers', 'points']
